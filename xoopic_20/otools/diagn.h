...
public:
  ...
  Scalar *Ave_KE_gridprob; ///IgalK change
  Scalar *number_gridprob; ///IgalK change	 	
  Scalar *total_density_gridprob; ///IgalK change
  Scalar *Ir_gridprob; //Igal change		
  //Scalar *EVDF_vec; ///omriH change
  ...
  // new diagnostics arrays - omri write to file:

  Scalar* KE_e_vec_save;
  Scalar* KE_i_vec_save;
  Scalar* KE_n_vec_save; 	
  Scalar* ne_avg_vec_save;  	
  Scalar* ni_avg_vec_save;
  Scalar* nn_avg_vec_save;	
  Scalar* Ie_FS_vec_save;
  Scalar* Ii_FS_vec_save;
  Scalar* Ie_anode_vec_save;
  Scalar* Ii_anode_vec_save;
  Scalar* In_FS_vec_save;
  Scalar* In_anode_vec_save;	
  Scalar* Ie_FS_beam_vec_save;
  Scalar* Ii_anode_beam_vec_save;	
  Scalar* phi_ij_vec_save;
  Scalar*** Ir_spc_avg;
  Scalar** Ir_spc_sum;
	int num_bound_Ir;

  Scalar t_avg, KE_e_sum, KE_i_sum , KE_n_sum, ne_avg_sum, ni_avg_sum ,nn_avg_sum, Ie_FS_sum,  Ii_FS_sum , Ie_anode_sum, Ii_anode_sum , In_FS_sum , In_anode_sum , Ie_FS_beam_sum, Ii_anode_beam_sum, phi_ij_sum;
  long i_time_step, i_avg;
  ...
  void dumpHistH5(dumpHDF5 &H5DumpObj); //added by Matteo
#endif
