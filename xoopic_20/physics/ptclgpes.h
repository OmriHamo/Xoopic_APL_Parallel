...
public:
	...
	//void advance(Vector3** ENode_local, Vector3** BNode_local , Grid&	grid , Vector2** X_local ,  Scalar dt);
	void advance(Fields& fields, Scalar dt);
	void omp_advance(ParticleGroup *group , Vector3** ENode_local, Vector3** BNode_local , Grid&	grid , Vector2** X_local ,  Scalar dt);
