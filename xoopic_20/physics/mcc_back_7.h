...
class BaseMCPackage {
 ...
 Scalar	maxRhoNeutral;//igal change		
...
class MCCPackage : public BaseMCPackage
{
 ...
 public:
  ...
  void dynamicCollide(ParticleGroupList** pgListfull, ParticleGroupList& pgList, Fields* fields, int index1,
               int index2, ParticleList& pList)throw(Oops);//IgalK change
...
{				//	list of newly created particles
 public:
  ...
  //ParticleList& dynamicCollide(ParticleGroupList** pgList1, Fields* fields,
  //                      int index1, int index2) throw(Oops);//IgalK change	
 private:
  MCC(const MCC&);
