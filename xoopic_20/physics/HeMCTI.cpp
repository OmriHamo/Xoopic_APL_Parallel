...
HeMCTI::HeMCTI(Scalar p, Scalar temp, Species* eSpecies, Species* iSpecies, Species* tSpecies,
  ...
  : MCTIPackage(He, (ostring)"He", p, temp, eSpecies, iSpecies, tSpecies, sList, dt, ionzFraction,
