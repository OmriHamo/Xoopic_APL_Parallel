...
class Dadi : public PoissonSolve
{
 ...
 protected:
  ...
  Scalar *r_x2,*v_x2,*gam_x2;
		int *i_min_arr, *i_maxp1_arr , *j_min_arr , *j_maxp1_arr ; // thread domain decomposition indecies

 Scalar **a_local_thread,**b_local_thread,**c_local_thread,**r_local_thread,**vx_local_thread,**gam_local_thread ;
  ...
  int nc1,nc2,ng1,ng2; // nc1 - J_max , nc2 - K_max , ng1 - J_max+1 , ng2 - K_max+1
