...
class MCCPackage : public BaseMCPackage
{
 ...
 public:
  ...
  void init2(ParticleGroupList** pgList1, Fields* fields, int index1, 
		                          int index2, Scalar species_dt);//IgalK change
...
{				//	list of newly created particles
 public:
  ...
  //ParticleList& collide(ParticleGroupList& pgList) throw(Oops);//IgalK change
  ParticleList& collide(ParticleGroupList** pgList1, Fields* fields, int index1, 
             int index2) throw(Oops);//IgalK change
  void init2(ParticleGroupList** pgList1,Fields* fields, int index1, 
             int index2, Scalar species_dt);//IgalK change
 private:
  MCC(const MCC&);
