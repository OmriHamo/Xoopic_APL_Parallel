...
// this function modifies an individual macro particle charge within the pgroup
//IgalK 4.4.15
void ParticleGroup::modifyParticleWeight(int particleIndex, Scalar newNP2C)
{
 if(qArray) 
    qArray[particleIndex] = q*newNP2C/np2c0;	
}
