...
#define PERIODIC_X2_DADI 5
#define PETSC_SOLVE 6
#define PERIODIC_X1_DADI 99
...
class Fields
{
  ...
  //Scalar ***  mppc_species ;  //  omriH. num of macro particles per cell by species
 ...
 public:
  ...
  void  collect_par2cells(ParticleGroup *group,Scalar **_mppc);
  ...
  void set_rhospecies(int id, int j, int k, Scalar value);//Igal change
  ...
  //Scalar *** getmppcSpecies() { return mppc_species; };			
