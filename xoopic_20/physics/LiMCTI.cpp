...
LiMCTI::LiMCTI(Scalar p, Scalar temp, Species* eSpecies, Species* iSpecies, Species* tSpecies, 
  ...
  : MCTIPackage(Li, (ostring)"Li", p, temp, eSpecies, iSpecies, tSpecies, sList, dt, ionzFraction,
