...
class XeMCC : public MCCPackage
{
 ...
 public:
  ...
  /** Set the dynamicMCCFlag and make sure the local
  *  static version, staticDyMCCFlag, is consistent.
  */
  //virtual void setDynamicMCC(int flag) {
  //    dynamicMCC = flag;
  //    staticDyMCC = flag;
  //  }
 //protected:		
      /** Local static version of the base class data member
		 *  dynamicMCCFlag, which is a flag specifying whether
		 *  the collisions, etc. should use dynamic background gas.
		 * IgalK 28.03.15
     */
  //static int staticDyMCC;
};
