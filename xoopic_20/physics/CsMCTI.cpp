...
CsMCTI::CsMCTI(Scalar p, Scalar temp, Species* eSpecies, Species* iSpecies, Species* tSpecies,
  ...
  : MCTIPackage(Cs, (ostring)"Cs", p, temp, eSpecies, iSpecies, tSpecies, sList, dt, 
                ionzFraction, ecxFactor, icxFactor, _SR, _Min1MKS, _Max1MKS, 
                _Min2MKS, _Max2MKS, _delayTime, _stopTime, analyticF,  NGDFname , 
