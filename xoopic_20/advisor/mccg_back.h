...
class MCCParams : public ParameterGroup
{
 ...
 protected:
   ...
   * the inverse Hall parameter. eTemp is the expected average elevtron
   * temperture in eV and maxBfield is the maximum magnetic field in Tesla.
   * IgalK: 09/03/15
   */
		
  IntParameter anomalousScatteringFlag; 
  ScalarParameter maxBField;
  ScalarParameter eTemp;
